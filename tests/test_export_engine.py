...
def test_xlsx_exporter():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        assert "Raw Results" in sheet_names, "Missing Raw Results sheet"
        assert "Backend Comparison" in sheet_names, "Missing Backend Comparison sheet"
        assert "Insights" in sheet_names, "Missing Insights sheet"
        assert "Metadata" in sheet_names, "Missing Metadata sheet"
