...
class DisplayController:
    ...
    def __init__(self) -> None:
        ...
        self._pending_update: Optional[DisplayUpdate] = None
...
class ETACalculator:
    ...
    def __init__(self) -> None:
        ...
        self._smoothed_rate: Optional[float] = None  # Progress per second
        self._last_update_time: float = 0.0
...
class ExecutionTimer:
    ...
    def _emit_update(self, reason: UpdateReason, message: Optional[str] = None) -> None:
    ...
    def _start_auto_update(self) -> None:
        ...
        self._update_thread = threading.Thread(
            ...
            daemon=True,
            name="ExecutionTimer-AutoUpdate"
        )
