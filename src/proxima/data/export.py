...
class XLSXExporter(BaseExporter):
        ...
        try:
            ...
            if options.include_raw_results and data.raw_results:
                ...
                self._write_results_sheet(
                    ws_results, data.raw_results, options, header_font, header_fill
                )
            ...
            if options.include_comparison and data.comparison:
                ...
                self._write_comparison_sheet(
                    ws_comparison, data.comparison, options, header_font, header_fill
                )
            ...
            if options.include_metadata and data.metadata:
                ...
                self._write_metadata_sheet(
                    ws_metadata, data.metadata, options, header_font, header_fill
                )
    ...
    def _write_summary_sheet(
        self, ws, data: ReportData, options: ExportOptions, header_font, header_fill
    ):
    ...
    def _write_results_sheet(
        self, ws, raw_results: list[dict], options: ExportOptions, header_font, header_fill
    ):
    ...
    def _write_comparison_sheet(
        self, ws, comparison: dict, options: ExportOptions, header_font, header_fill
    ):
    ...
    def _write_metadata_sheet(
        self, ws, metadata: dict, options: ExportOptions, header_font, header_fill
    ):
